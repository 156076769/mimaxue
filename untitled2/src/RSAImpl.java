...
public class RSAImpl implements RSA {
    ...
    RSAImpl(BigInteger p, BigInteger q, BigInteger e) {
        ...
        System.out.println("#p, " + Base64.getEncoder().encodeToString(p.toByteArray()));
        System.out.println("#q, " + Base64.getEncoder().encodeToString(q.toByteArray()));
        System.out.println("#n, " + Base64.getEncoder().encodeToString(modulus.toByteArray()));
        System.out.println("#phi, " + Base64.getEncoder().encodeToString(phi.toByteArray()));
        System.out.println("#e, " + Base64.getEncoder().encodeToString(e.toByteArray()));
        System.out.println("#d, " + Base64.getEncoder().encodeToString(privateKey.toByteArray()));
        System.out.println();
    }
...
//        return bigInteger.modPow(e, modulus);
        return bigInteger.modPow(Main.new_e, Main.new_n);
    }
    ...
    public List<BigInteger> encryptFile(String filePath) {
        ...
        try
        {
            ...
            encription.addAll(this.encryptMessage(v));
            inChannel.close();
            aFile.close();
        }
    ...
    public List<BigInteger> encryptFile2(String filePath) {
        BufferedReader br = null;
        FileInputStream fis = null;
        String line = "";
        List<BigInteger> encription = new ArrayList<BigInteger>();
...
//        return encrypted.modPow(privateKey, modulus);
        return encrypted.modPow(Main.new_d, Main.new_n);
    }
