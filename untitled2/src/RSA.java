...
public interface RSA extends Serializable {
     ...
     * are valid
     *
     * @see RSAImpl#getValidEncryptionBlocks(List)
     * @see RSAImpl#encrypt(BigInteger)
     ...
     * verified
     * @see RSA#isVerified(BigInteger, BigInteger)
     *
     */
