...
Java_com_superads_mimaxue2_NativeEntry_getAESEncrypt(JNIEnv *env, jobject instance, jstring str_) {
...
JNIEXPORT jstring JNICALL
Java_com_superads_mimaxue2_NativeEntry_getAESDecrypt(JNIEnv *env, jobject instance, jstring str_) {
